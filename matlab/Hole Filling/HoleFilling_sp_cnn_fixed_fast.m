function HoleFilling_sp_cnn_fixed_fast()
...
my_csvwrite('fixed_interval_fast_results/results.csv', raw);
end
...
[runData, state, output ] = sp_cnn_fast('fixed-interval', cnn_dim, r, A, B, z, initState, u, ...
    partitions, interval, numCNN );
file_header = sprintf('fixed_interval_fast_results/%s_%d', test_name, numCNN);
