function HoleFilling_sp_cnn_fixed()
...
my_csvwrite('fixed_interval_results/results.csv', raw);
end
...
[runData, state, output ] = sp_cnn('fixed-interval', cnn_dim, r, A, B, z, initState, u, ...
    partitions, interval, numCNN );
file_header = sprintf('fixed_interval_results/%s_%d', test_name, numCNN);
